 ...
 * @Description: 由Fragment启动EasyPhotos的测试界面
 * @Author: bubing
 * @Date: 2020-05-09 21:29
 */
public class CameraPhoto2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_photo2);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_camera_photo, container, false);
