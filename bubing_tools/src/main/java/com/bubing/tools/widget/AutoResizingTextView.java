...
public class AutoResizingTextView extends AppCompatTextView implements BitmapGenerator {
    private String TAG = "AutoResizingTextView ";
    ...
    private int efficientTextSizeSearch(int start, int end,
        ...
        if (isTextOnly) {
            //添加10个字换行
            text = StringUtils.lineFeedText(getText().toString());
        }
