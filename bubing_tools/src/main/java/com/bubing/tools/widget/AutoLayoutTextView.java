...
public class AutoLayoutTextView extends AppCompatTextView {
    private String TAG = "AutoLayoutTextView ";
...
//        videoHeight = height;
    ...
    public Bitmap layoutToBitmap() {
        ...
        if (layout == null) {
            ...
            super.measure(View.MeasureSpec.makeMeasureSpec(w, View.MeasureSpec.EXACTLY),
    ...
    private boolean generateFileFromBitmap(Bitmap bmp, String outputPath, String srcMimeType) throws IOException {
        ...
        if (outputPath.endsWith("jpg") || outputPath.endsWith("jpeg") || srcMimeType.endsWith("jpg") || srcMimeType.endsWith("jpeg")) {
    ...
    public void setText(final CharSequence text, TextView.BufferType type) {
        super.setText(filtrateText(text), TextView.BufferType.EDITABLE);
    }
