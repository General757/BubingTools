package com.bubing.tools.loading.render.goods;
...
/**
 * @ClassName: BalloonLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:50 PM
...
public class BalloonLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mGasTubeWidth = DensityUtils.dip2px(context, DEFAULT_GAS_TUBE_WIDTH);
        mGasTubeHeight = DensityUtils.dip2px(context, DEFAULT_GAS_TUBE_HEIGHT);
        mCannulaWidth = DensityUtils.dip2px(context, DEFAULT_CANNULA_WIDTH);
        mCannulaHeight = DensityUtils.dip2px(context, DEFAULT_CANNULA_HEIGHT);
        mCannulaOffsetY = DensityUtils.dip2px(context, DEFAULT_CANNULA_OFFSET_Y);
        mCannulaMaxOffsetY = DensityUtils.dip2px(context, DEFAULT_CANNULA_MAX_OFFSET_Y);
        mPipeBodyWidth = DensityUtils.dip2px(context, DEFAULT_PIPE_BODY_WIDTH);
        mPipeBodyHeight = DensityUtils.dip2px(context, DEFAULT_PIPE_BODY_HEIGHT);
        mBalloonWidth = DensityUtils.dip2px(context, DEFAULT_BALLOON_WIDTH);
        mBalloonHeight = DensityUtils.dip2px(context, DEFAULT_BALLOON_HEIGHT);
        mRectCornerRadius = DensityUtils.dip2px(context, DEFAULT_RECT_CORNER_RADIUS);
