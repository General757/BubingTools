...
/**
 * @ClassName: WhiteLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:48 PM
 * @Description: java类作用描述
 */
public class WhiteLoadingRenderer extends LoadingRenderer {
    ...
    private static final int[] DEFAULT_COLORS = new int[]{Color.WHITE, Color.WHITE, Color.WHITE};
    ...
    private WhiteLoadingRenderer(Context context) {
        super(context);
        init(context);
        setupPaint();
