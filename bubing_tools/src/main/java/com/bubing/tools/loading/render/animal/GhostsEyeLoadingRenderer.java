package com.bubing.tools.loading.render.animal;
...
/**
 * @ClassName: GhostsEyeLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:42 PM
...
public class GhostsEyeLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mEyeEdgeWidth = DensityUtils.dip2px(context, DEFAULT_EYE_EDGE_WIDTH);

        mEyeInterval = DensityUtils.dip2px(context, DEFAULT_EYE_CIRCLE_INTERVAL);
        mEyeBallOffsetY = DensityUtils.dip2px(context, DEFAULT_EYE_BALL_OFFSET_Y);
        mEyeCircleRadius = DensityUtils.dip2px(context, DEFAULT_EYE_CIRCLE_RADIUS);
        mMaxEyeJumptDistance = DensityUtils.dip2px(context, DEFAULT_MAX_EYE_JUMP_DISTANCE);
        mAboveRadianEyeOffsetX = DensityUtils.dip2px(context, DEFAULT_ABOVE_RADIAN_EYE_CIRCLE_OFFSET);

        mEyeBallWidth = DensityUtils.dip2px(context, DEFAULT_EYE_BALL_WIDTH);
        mEyeBallHeight = DensityUtils.dip2px(context, DEFAULT_EYE_BALL_HEIGHT);
