...
public class FishLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mRiverBankWidth = DensityUtils.dip2px(context, DEFAULT_RIVER_BANK_WIDTH);

        mPathFullLineSize = DensityUtils.dip2px(context, DEFAULT_PATH_FULL_LINE_SIZE);
        mPathDottedLineSize = DensityUtils.dip2px(context, DEFAULT_PATH_DOTTED_LINE_SIZE);
        mFishWidth = DensityUtils.dip2px(context, DEFAULT_FISH_WIDTH);
        mFishHeight = DensityUtils.dip2px(context, DEFAULT_FISH_HEIGHT);
        mFishEyeSize = DensityUtils.dip2px(context, DEFAULT_FISH_EYE_SIZE);
        mRiverWidth = DensityUtils.dip2px(context, DEFAULT_RIVER_WIDTH);
        mRiverHeight = DensityUtils.dip2px(context, DEFAULT_RIVER_HEIGHT);
