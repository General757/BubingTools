package com.bubing.tools.loading.render.circle.jump;
...
/**
 * @ClassName: CollisionLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:43 PM
...
public class CollisionLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mOvalVerticalRadius = DensityUtils.dip2px(context, DEFAULT_OVAL_HEIGHT);
