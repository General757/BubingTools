package com.bubing.tools.loading.render.shapechange;
...
/**
 * @ClassName: CircleBroodLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:53 PM
...
public class CircleBroodLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mMaxMotherOvalSize = DensityUtils.dip2px(context, MAX_MATHER_OVAL_SIZE);
        mBasicChildOvalRadius = DensityUtils.dip2px(context, MIN_CHILD_OVAL_RADIUS);
