package com.bubing.tools.loading.render.scenery;
...
/**
 * @ClassName: DayNightLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:51 PM
...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mStarRadius = DensityUtils.dip2px(context, DEFAULT_STAR_RADIUS);
        mSun$MoonRadius = DensityUtils.dip2px(context, DEFAULT_SUN$MOON_RADIUS);
        ...
        mSunRayStartCoordinateY = mInitSun$MoonCoordinateY - mMaxSun$MoonRiseDistance //the center
                ...
                - DensityUtils.dip2px(context, DEFAULT_SUN_RAY_OFFSET); //sub the interval between the sun and the sun ray

        //add strokeWidth * 2.0f because the stroke cap is Paint.Cap.ROUND
        mSunRayEndCoordinateY = mSunRayStartCoordinateY - DensityUtils.dip2px(context, DEFAULT_SUN_RAY_LENGTH)
                + mStrokeWidth;
