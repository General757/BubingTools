...
/**
 * @ClassName: ElectricFanLoadingRenderer
 * @Author: Bubing
 * @Date: 2020/8/24 3:52 PM
...
public class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mLeafDrawable = context.getResources().getDrawable(R.drawable.image_eletric_leaf);
        mLoadingDrawable = context.getResources().getDrawable(R.drawable.image_eletric_loading);
        mElectricFanDrawable = context.getResources().getDrawable(R.drawable.image_eletric_fan);
