...
/**
 * Created by XO on 17/8/15 下午7:33.
 */
...
public class SnackbarLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int multiLineVPadding = getResources().getDimensionPixelSize(R.dimen.snackbar_padding_design_vertical);
        final int singleLineVPadding = getResources().getDimensionPixelSize(R.dimen.snackbar_padding_vertical);
