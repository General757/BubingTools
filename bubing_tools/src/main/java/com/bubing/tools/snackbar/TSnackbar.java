package com.bubing.tools.snackbar;
...
public final class TSnackbar {
    ...
    private void animateViewIn() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            ViewCompat.animate(mView)
                    .translationY(0f)
                    .setInterpolator(SnackAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR)
            ...
            Animation anim = android.view.animation.AnimationUtils.loadAnimation(mView.getContext(), R.anim.snack_into);
            anim.setInterpolator(SnackAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private void animateViewOut(final int event) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            Animation anim = android.view.animation.AnimationUtils.loadAnimation(mView.getContext(), R.anim.snack_out);
            anim.setInterpolator(SnackAnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            anim.setDuration(ANIMATION_DURATION);
            anim.setAnimationListener(new Animation.AnimationListener() {
                @Override
