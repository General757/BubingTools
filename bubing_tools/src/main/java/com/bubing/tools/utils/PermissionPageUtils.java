...
public class PermissionPageUtils {
    ...
    private final String TAG = "PermissionPageUtils";
    private Context mContext;
    //自己的项目包名
    private String packageName = "com.linyun.show";
    String noticeStr = "跳转失败";

    public PermissionPageUtils(Context context) {
        this.mContext = context;
        noticeStr = mContext.getString(R.string.permission_open_setting_activity_fail);
    }
    ...
    private void goLGMainager() {
        try {
            ...
            Toast.makeText(mContext, noticeStr, Toast.LENGTH_LONG).show();
            e.printStackTrace();
            goIntentSetting();
        }
    }
    ...
    private void goXiaoMiMainager() {
        ...
        LogUtils.e(TAG, "goMiaoMiMainager --- rom : " + rom);
        if (TextUtils.isEmpty(rom)) goIntentSetting();
        else {
