...
public class CompressHelper {
    ...
    private CompressHelper(Context context) {
        ...
        destinationDirectoryPath = context.getCacheDir().getPath() + File.pathSeparator + CompressFileHelper.FILES_PATH;
    }
    ...
    public File compressToFile(File file) {
        return CompressBitmapHelper.compressImage(context, Uri.fromFile(file), maxWidth, maxHeight, compressFormat, bitmapConfig, quality, destinationDirectoryPath, fileNamePrefix, fileName);
    }
    ...
    public Bitmap compressToBitmap(File file) {
        return CompressBitmapHelper.getScaledBitmap(context, Uri.fromFile(file), maxWidth, maxHeight, bitmapConfig);
    }
