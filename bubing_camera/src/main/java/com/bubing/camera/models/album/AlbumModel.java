package com.bubing.camera.models.album;
...
public class AlbumModel {
    ...
    private void initAlbum(Context context) {
        ...
        String[] selectionAllArgs = {String.valueOf(MediaStore.Files.FileColumns.MEDIA_TYPE_IMAGE), String.valueOf(MediaStore.Files.FileColumns.MEDIA_TYPE_VIDEO)};
...
//            Log.d(TAG, "call: " + "Empty photos");
            ...
            do {
                ...
                boolean isVideo = type.contains(Constants.Type.VIDEO);// 是否是视频
                ...
                if (!Setting.showGif) {
                    if (path.endsWith(Constants.Type.GIF) || type.endsWith(Constants.Type.GIF)) {
                        continue;
                    }
                }
